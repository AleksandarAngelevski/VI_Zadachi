...
class Laser(Problem):
    def __init__(self, initial,N,M, target, allowed): 
    ...
    def successor(self, state):
        ...
        for key, value in dirs.items():
            new_state = [state] 
            if self.isValid(self.moveMan(state[0], value)):
                new_state[0] = self.moveMan(state[0], value)
...
if __name__ == '__main__':
    ...
    problem = Laser(state, N, M, target_pos, allowed)
